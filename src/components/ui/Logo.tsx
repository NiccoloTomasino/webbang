  ...
  return (
    <svg viewBox="0 0 40 40" className={cn("h-9 w-9", className)} aria-hidden>
      <path
        ...
        fill="#FFD60A"
      />
      <path d="M17.2 11.5h5.6l-1 11h-3.6z M20 24.8a2.6 2.6 0 110 5.2 2.6 2.6 0 010-5.2z" fill="#0b0b0d" />
    </svg>
  );
}
...
export function Logo({ className }: { className?: string }) {
  return (
    <span className={cn("group inline-flex select-none items-center gap-2.5", className)}>
      ...
      <span className="font-display text-[22px] font-extrabold leading-none tracking-tight text-ink">
        web<span className="text-bang-ink">bang</span>
      </span>
    </span>
  );
}
